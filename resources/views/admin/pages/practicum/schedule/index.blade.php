            ...
            <div class="card-body">
                <div id="period_subject_table_wrapper" class="dataTables_wrapper dt-bootstrap4 w-100">
                    <table id="period_subject_table"
                        ...
                        <thead>
                            <tr>
                                <th style="text-align: center" tabindex="0" aria-controls="period_subject_table"
                                    rowspan="1" colspan="1">Kelas</th>
                                <th style="text-align: center" tabindex="0" aria-controls="period_subject_table"
                                    rowspan="1" colspan="1">Jadwal</th>
                                <th style="text-align: center" tabindex="0" aria-controls="period_subject_table"
                                    rowspan="1" colspan="1">Jumlah Asisten</th>
                                <th style="text-align: center" tabindex="0" aria-controls="period_subject_table"
                        ...
                        <tbody>
                            <tr>
                                <td tabindex="0">rand(Mata Kuliah {{ rand(1,5) }} - {{ rand(1,5) }})</td>
                                <td style="text-align: center;">rand( Senin, {{ rand(11,17) }}:{{ rand(11,59) }} - {{ rand(11,17) }}:{{ rand(11,59) }} )</td>
                                <td style="text-align: center;">rand({{ rand(1,5) }})</td>
                                ...
                                <td>
                                    <div class="d-flex align-items-center justify-content-between">
                                        ...
                                        <!-- Edit Schedule Modal -->
                                        <div class="modal fade" id="scheduleEditFormModal_1"
                                            tabindex="-1" data-backdrop="static" data-keyboard="false"
                                            aria-labelledby="scheduleEditFormModalLabel_1"
                                            aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h3 class="modal-title font-weight-bold"
                                                            id="scheduleEditFormModalLabel_1">Ubah Jadwal Praktikum</h3>
                                                    ...
                                                    <form method="POST">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <p class="d-block m-0 mb-1 font-weight-bold">Jadwal</p>
                                                            <div class="form-group">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="time" id="practicum_end"
                                                                    name="practicum_end" class="form-control" required
                                                                    autocomplete="off">
                                                            </div>
                                                            <div class="form-group">
                                        ...
                                        <div class="modal fade" id="confirmDeleteScheduleModal_1"
                                            tabindex="-1" data-backdrop="static" data-keyboard="false"
                                            aria-labelledby="confirmDeleteScheduleModalLabel_1"
                                            aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
