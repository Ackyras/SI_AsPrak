    ...
    <div class="card">
        <div class="card-header">
            <div class="d-flex align-items-center justify-content-between mb-4">
                ...
                {{-- <a role="button" href="{{ route('admin.data.master.period.subject.question.create'), [ $period, $subject] }}" class="d-block btn btn-success" data-toggle="modal" data-target="#subjectFormModal"> --}}
                <a href="{{ route('test.123') }}" class="btn btn-success">
            ...
            <div class="">
                <div>
                    ...
                    <div style=" border-left: 5px solid #34d399; background-color: #ecfdf5" class="d-flex justify-content-between mb-4 p-2">
                        ...
                        <div style="width: 96%;" class="pl-2">
                            ...
                            <div class="d-flex justify-content-between {{ $question->choices->count() > 0 ? '' : 'mt-2'}}">
                                ...
                                <p class="d-block m-0">:</p>
                                <p style="width: 88%" class="d-block m-0"><span class="badge badge-success">{{ $question->score }} poin</span></p>
                            </div>
                        </div>
                    </div>
                    @empty
