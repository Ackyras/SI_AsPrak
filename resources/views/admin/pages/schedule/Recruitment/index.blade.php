                        ...
                        <div class="card-body p-0">
                            <div id="calendar" class="fc fc-media-screen fc-direction-ltr fc-theme-bootstrap">
                                <div class="fc-header-toolbar fc-toolbar fc-toolbar-ltr">
                                    ...
                                    <div class="fc-toolbar-chunk">
                                        <div class="btn-group">
                                            <button class="fc-dayGridMonth-button btn btn-primary active"
                                ...
                                <div class="fc-view-harness fc-view-harness-active" style="height: 439.259px;">
                                                    ...
                                                    <td>
                                                        <div class="fc-scroller-harness">
                                                            <div class="fc-scroller" style="overflow: hidden scroll;">
                                                                <table class="fc-col-header " style="width: 574px;">
                                                                    <colgroup>
                                                                    </colgroup>
                                                                    <tbody>
                                                                        <tr>
                                                            ...
                                                            <div class="fc-scroller fc-scroller-liquid-absolute"
                                                                ...
                                                                <div class="fc-daygrid-body fc-daygrid-body-unbalanced "
                                                                    ...
                                                                    <table class="fc-scrollgrid-sync-table"
                                                                        style="width: 574px; height: 407px;">
                                                                        <colgroup></colgroup>
                                                                        <tbody>
                                                                            <tr>
                                                                            ...
                                                                            <tr>
                                                                                <td class="fc-daygrid-day fc-day fc-day-sun fc-day-today "
...
@section('scripts')
    ...
    <script src="{{ asset('js/others/moment.min.js') }}"></script>
