                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" id="number_of_lab_assistant"
                                                                ...
                                                                placeholder="(masukkan angka)" min="0"
            ...
            <form method="POST" action="{{ route('admin.active-period.data.add-period-subject', $period) }}">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="number_of_class" name="number_of_class" class="form-control" required
                            autocomplete="off" min="1" value="{{ old('number_of_class') }}"
