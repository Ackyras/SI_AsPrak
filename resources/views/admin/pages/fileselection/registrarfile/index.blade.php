            ...
            <div class="card-body">
                <div id="period_subject_registrar_table_wrapper" class="dataTables_wrapper dt-bootstrap4">
                    ...
                    <table id="period_subject_registrar_table" class="table table-bordered table-hover dataTable dtr-inline collapsed"
                        ...
                        <thead>
                            <tr>
                                <th style="text-align: center" tabindex="0" aria-controls="period_subject_registrar_table" rowspan="1"
                                    colspan="1">Nama</th>
                                <th style="text-align: center" tabindex="0" aria-controls="period_subject_registrar_table" rowspan="1"
                                    colspan="1">NIM</th>
                                <th style="text-align: center" tabindex="0" aria-controls="period_subject_registrar_table" rowspan="1"
                                    colspan="1">Mata Kuliah</th>
                                <th style="text-align: center; width: 15%" tabindex="0" aria-controls="period_subject_registrar_table" rowspan="1"
                                    colspan="1">Berkas</th>
                                <th style="text-align: center; width: 15%" tabindex="0" aria-controls="period_subject_registrar_table" rowspan="1"
                                    colspan="1">Status</th>
                            </tr>
                        ...
                        <tbody>
                            @foreach ($period_subject_registrars as $psr)
                                <tr>
                                    ...
                                    <td data-search="{{ $psr->subject->name }}"> {{ $psr->subject->name }} </td>
                                    <td>
                                        <div class="btn-group btn-group-sm" role="group" aria-label="Basic example">
                                            <button type="button" class="btn btn-info">CV</button>
                                            <button type="button" class="btn btn-info">KHS</button>
                                    ...
                                    {{-- <td>
                                        <div class="d-flex align-items-center justify-content-between">
                                            ...
                                            <!-- Edit Period Modal -->
                                            <div class="modal fade" id="periodEditFormModal{{ $period->id }}"
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input type="text" id="name" name="name" class="form-control" required
                                autocomplete="off" placeholder="Ganjil 20XX/20XX">
                        </div>
                    </div>
