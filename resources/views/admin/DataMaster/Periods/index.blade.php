            ...
            <table id="period_table" class="table table-bordered table-hover dataTable dtr-inline collapsed"
                ...
                <tbody>
                    ...
                    <tr class="{{ $loop->index % 2 == 0 ? 'even' : 'odd' }}">
                        ...
                        <td>{{ \Carbon\Carbon::parse($period->registration_start)->toDayDateTimeString() }}</td>
                        <td>{{ \Carbon\Carbon::parse($period->registration_end)->toDayDateTimeString() }}</td>
                        <td> <a href="{{ route('admin.data.master.period.show', $period) }}">Detail</a> </td>
                    </tr>
                    @endforeach
                </tbody>
                <tfoot>
