...
<div class="w-full lg:w-3/5 m-auto bg-white drop-shadow-md p-4 lg:p-10 min-h-[calc(100vh-4.75rem)] lg:min-h-[calc(100vh-5.5rem)]">
    ...
    <div class="w-full mb-2 pb-2 border-b-2 border-emerald-600">
        ...
        <p class="mb-2 lg:pl-2">
            Lorem ipsum dolor sit amet consectetur, adipisicing elit. Ex maxime nam nisi aliquam alias, eos molestiae! Libero, odit! At, reprehenderit. Accusamus iusto blanditiis velit aut ab dolor tenetur officiis in!
        </p>
        ...
        <table class="lg:ml-2">
            ...
            <tr>
                ...
                <td>{{ $subject->name }}</td>
                <td class="pl-3">( <span class="font-semibold text-emerald-700">{{ $subject->pivot->number_of_lab_assistant }} orang</span> )</td>
            </tr>
            @empty
            <tr><td>Tidak ada asisten yang dibutuhkan</td></tr>
            @endforelse
        </table>
    </div>
    <div class="mt-4">
