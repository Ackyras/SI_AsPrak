        ...
        <form action="" enctype="multipart/form-data" method="POST">
            ...
            <div class="mb-6"
                ...
                <div class="mb-4">
                    ...
                    <input class="w-full py-1 px-2 lg:py-2 lg:px-3 text-emerald-800 font-semibold bg-emerald-50 border border-white focus:ring-1 lg:focus:ring-2 focus:border-white focus:ring-emerald-600 focus:ring-opacity-50-emerald-200" type="text" name="name" id="name" autocomplete="off" required />
                </div>
                <!-- NIM -->
                <div class="mb-4">
                    <label class="block w-full text-gray-500 mb-2 text-lg font-semibold" for="nim">Nomor Induk Mahasiswa</label>
                    <input class="w-full py-1 px-2 lg:py-2 lg:px-3 text-emerald-800 font-semibold bg-emerald-50 border border-white focus:ring-1 lg:focus:ring-2 focus:border-white focus:ring-emerald-600 focus:ring-opacity-50-emerald-200" type="text" name="nim" id="nim" autocomplete="off" required />
                </div>
                <!-- EMAIL -->
                <div class="mb-4">
                    <label class="block w-full text-gray-500 mb-2 text-lg font-semibold" for="email">Alamat Email</label>
                    <input class="w-full py-1 px-2 lg:py-2 lg:px-3 text-emerald-800 font-semibold bg-emerald-50 border border-white focus:ring-1 lg:focus:ring-2 focus:border-white focus:ring-emerald-600 focus:ring-opacity-50-emerald-200" type="email" name="email" id="email" autocomplete="off" required />
                </div>
                <!-- PASSWORD -->
                <div class="mb-4">
                    <label class="block w-full text-gray-500 mb-2 text-lg font-semibold" for="password">Kata Sandi</label>
                    <input class="w-full py-1 px-2 lg:py-2 lg:px-3 text-emerald-800 font-semibold bg-emerald-50 border border-white focus:ring-1 lg:focus:ring-2 focus:border-white focus:ring-emerald-600 focus:ring-opacity-50-emerald-200" type="password" name="password" id="password" required />
                </div>
                <!-- PASSWORD CONFIRMATION -->
                <div class="mb-4">
                    <label class="block w-full text-gray-500 mb-2 text-lg font-semibold" for="password_confirmation">Konfirmasi Kata Sandi</label>
                    <input class="w-full py-1 px-2 lg:py-2 lg:px-3 text-emerald-800 font-semibold bg-emerald-50 border border-white focus:ring-1 lg:focus:ring-2 focus:border-white focus:ring-emerald-600 focus:ring-opacity-50-emerald-200" type="password" name="password_confirmation" id="password_confirmation" required>
                </div>
                <!-- SUBJECT -->
                <div class="mb-4">
                    ...
                    <div class="px-2">
                        @foreach ($subjects as $subject)
                            <input type="checkbox" id="subject_{{ $subject->id }}" name="subject{{ $subject->id }}" value="{{ $subject->id }}" class="subject-checkbox hidden">
                ...
                <div class="mb-4">
                    ...
                    <p id="cvnamecontainer" class="hidden w-fit border-2 py-1 px-2 gap-2 items-center bg-emerald-50 border-emerald-400 text-emerald-600">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" viewBox="0 0 20 20" fill="currentColor">
                    ...
                    <p id="cverrorcontainer" class="hidden w-fit mb-2 border-2 py-1 px-2 gap-2 items-center bg-red-50 border-red-400 text-red-600">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" viewBox="0 0 20 20" fill="currentColor">
                    ...
                    <label class="w-fit block" for="cv">
                        <p id="ganticv" class="hidden cursor-pointer mt-2 px-1 italic font-bold tracking-wider text-sm text-gray-400 hover:text-gray-500">
                            Ganti File
                        </p>
                        <div id="pilihcv" class="flex border cursor-pointer items-center py-1 pl-3 pr-5 gap-3 text-emerald-600 hover:bg-emerald-50">
                ...
                <div class="mb-4">
                    ...
                    <p id="khsnamecontainer" class="hidden w-fit border-2 py-1 px-2 gap-2 items-center bg-emerald-50 border-emerald-400 text-emerald-600">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" viewBox="0 0 20 20" fill="currentColor">
                            <path fill-rule="evenodd" d="M4 4a2 2 0 012-2h4.586A2 2 0 0112 2.586L15.414 6A2 2 0 0116 7.414V16a2 2 0 01-2 2H6a2 2 0 01-2-2V4z" clip-rule="evenodd" />
                        </svg>
                    ...
                    <p id="khserrorcontainer" class="hidden w-fit mb-2 border-2 py-1 px-2 gap-2 items-center bg-red-50 border-red-400 text-red-600">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" viewBox="0 0 20 20" fill="currentColor">
                            <path fill-rule="evenodd" d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z" clip-rule="evenodd" />
                        </svg>
                    ...
                    <label class="w-fit block" for="khs">
                        <p id="gantikhs" class="hidden cursor-pointer mt-2 px-1 italic font-bold tracking-wider text-sm text-gray-400 hover:text-gray-500">
                            Ganti File
                        </p>
                        <div id="pilihkhs" class="flex border cursor-pointer items-center py-1 pl-3 pr-5 gap-3 text-emerald-600 hover:bg-emerald-50">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-8l-4-4m0 0L8 8m4-4v12" /></svg>
                            <p class="font-bold">
                                Pilih File
                            </p>
                ...
                <div class="mb-4">
                    ...
                    <p id="transkripnamecontainer" class="hidden w-fit border-2 py-1 px-2 gap-2 items-center bg-emerald-50 border-emerald-400 text-emerald-600">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" viewBox="0 0 20 20" fill="currentColor">
                            <path fill-rule="evenodd" d="M4 4a2 2 0 012-2h4.586A2 2 0 0112 2.586L15.414 6A2 2 0 0116 7.414V16a2 2 0 01-2 2H6a2 2 0 01-2-2V4z" clip-rule="evenodd" />
                        </svg>
                    ...
                    <p id="transkriperrorcontainer" class="hidden w-fit mb-2 border-2 py-1 px-2 gap-2 items-center bg-red-50 border-red-400 text-red-600">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" viewBox="0 0 20 20" fill="currentColor">
                            <path fill-rule="evenodd" d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z" clip-rule="evenodd" />
                        </svg>
                    ...
                    <label class="w-fit block" for="transkrip">
                        <p id="gantitranskrip" class="hidden cursor-pointer mt-2 px-1 italic font-bold tracking-wider text-sm text-gray-400 hover:text-gray-500">
                            Ganti File
                        </p>
                        <div id="pilihtranskrip" class="flex border cursor-pointer items-center py-1 pl-3 pr-5 gap-3 text-emerald-600 hover:bg-emerald-50">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-8l-4-4m0 0L8 8m4-4v12" /></svg>
                            <p class="font-bold">
                                Pilih File
                            </p>
