<template>
    ...
    <div class="md:pt-24 py-4">
        <div class="px-4 md:px-10 mx-auto w-full">
            <!-- MESSAGES CONTAINER -->
            <div v-if="$page.props.alert" class="mb-4 flex justify-between items-center p-2 text-white font-semibold drop-shadow rounded"
                :class="{
            ...
            <div class="" v-if="show_exam_warning">
                <div class="flex justify-between items-start bg-amber-50 rounded p-2 drop-shadow">
