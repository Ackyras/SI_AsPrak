<template>
    ...
    <div
        v-if="is_success"
        class="fixed z-[999] bottom-10 inset-x-0 flex justify-center"
    >
        <p
            class="block px-2 py-1 rounded drop- md:drop-shadow-none bg-emerald-100 text-emerald-600"
        >
            {{ result }}
        </p>
    </div>
    <div
        ...
        class="fixed z-[999] bottom-10 inset-x-0 flex justify-center"
    >
        <p class="block px-2 py-1 text-red-600 bg-red-100 rounded drop-shadow">
            {{ result }}
        </p>
    </div>
    <div
