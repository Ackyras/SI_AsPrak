<template>
                ...
                <ul class="flex flex-col list-none md:flex-col md:min-w-full md:mb-4">
                    ...
                    <li>
                        <Link
                            ...
                            :href="route('user.dashboard')" :class="{
                                'text-emerald-500':
                                    $page.url.startsWith('/dashboard'),
                            }">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 md:w-5 md:h-5" viewBox="0 0 20 20" fill="currentColor">
                    ...
                    <li>
                        <Link
                            class="flex items-center w-full gap-2 px-2 py-2 mb-2 text-xs font-bold text-gray-700 uppercase hover:text-emerald-500 md:text-sm"
                            :href="route('user.exam.index')" :class="{
                                'text-emerald-500':
                    ...
                    <li>
                        <Link
                            class="flex items-center w-full gap-2 px-2 py-2 mb-2 text-xs font-bold text-gray-700 uppercase hover:text-emerald-500 md:text-sm"
                            :href="route('user.schedule')" :class="{
                                'text-emerald-500':
                    ...
                    <li>
                        <Link
                            class="flex items-center w-full gap-2 px-2 py-2 mb-2 text-xs font-bold text-gray-700 uppercase hover:text-emerald-500 md:text-sm"
                            :href="route('user.presence')" :class="{
                                'text-emerald-500':
                    ...
                    <li>
                        <button type="button"
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 md:w-5 md:h-5" viewBox="0 0 20 20"
                                fill="currentColor">
                                <path fill-rule="evenodd"
    ...
    <div v-if="show_reader" class="fixed z-[1000] inset-0 flex items-center justify-center bg-gray-600 bg-opacity-75">
        ...
        <div class="rounded shadow bg-white p-6 w-[22.5rem] md:w-[23rem] lg:w-[25rem] xl:w-[27.5rem]">
            <!-- <barcode-scanner/> -->
            <div class="flex items-center justify-between mb-4">
                <p class="text-xl font-bold tracking-wide text-green-600 md:text-2xl">
                    Scan Barcode
                </p>
                <button type="button" class="px-3 py-1 text-xl text-gray-600 border rounded" v-on:click="closeReader">
                    <i class="fas fa-times"></i>
                </button>
            </div>
            <div class="relative w-full aspect-square">
                <div v-if="is_loading" class="absolute z-[1010] inset-0 bg-gray-50 flex items-center justify-center">
                ...
                <qrcode-stream :camera="camera_status" @decode="onDecode" @init="onInit" />
            </div>
        </div>
    </div>
</template>
